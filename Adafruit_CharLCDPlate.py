...
if __name__ == '__main__':
    ...
    lcd.clear()
    lcd.autoscroll()
    lcd.message("Motha Fuckin'\nRaspberry Pi!!")
    
    btn = ((lcd.SELECT, 'Operating Mode', lcd.ON),
        (lcd.LEFT,  'Change param 1', lcd.ON),
        (lcd.RIGHT, 'Change param 2', lcd.ON),
        (lcd.UP, 'Change param 3', lcd.ON),
        (lcd.DOWN, 'BLINK CURSON', lcd.scrollDisplayRight()))
